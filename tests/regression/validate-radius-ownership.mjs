...
assert.match(radius, /Marquee shells are cards; their short, repeated day tiles are compact controls\.[\s\S]*\.dashboard-week-day \{\s*border-radius: var\(--talaan-control-radius\) !important/s);
